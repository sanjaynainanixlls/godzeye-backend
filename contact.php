                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="contact-form">
                            <label>
                                <input type="text" id='username' class="form-input js-input" name="username" />
                                <span>Your name</span>
                            </label>

                            <label>
                                <input type="text" id="email" class="form-input js-input" name="email" />
                                <span>E-mail address</span>
                            </label>

                            <label>
                                <input type="tel" id='mobile' class="form-input js-input" name="mobile" />
                                <span>Mobile</span>
                            </label>

                            <label>
                                <textarea id='message' class="form-input js-input" name="message"></textarea>
                                <span>Message</span>
                            </label>

                            <button id='submit_form' class="btn theme-btn-1">
